# QuestLog (web) — frontend, gains a real test suite in Module 08

This is Module 07's finished, authenticated `questlog` frontend, copied
forward. **The application code below is unchanged from Module 07** —
this module adds Vitest + React Testing Library and four real test files
(`src/components/QuestForm.test.tsx`, `ProtectedRoute.test.tsx`,
`QuestCard.test.tsx`, `src/pages/QuestListPage.test.tsx` — 17 tests
total, all passing) plus `prettier` for formatting. See
[`../../BRIEF.md`](../../BRIEF.md) for the full capstone brief and
[`../../../lessons/07-frontend-testing-with-vitest-and-rtl.md`](../../../lessons/07-frontend-testing-with-vitest-and-rtl.md)
for the teaching material behind every test file.
