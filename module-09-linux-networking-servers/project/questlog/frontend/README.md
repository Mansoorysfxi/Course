# QuestLog (web) — frontend (Module 08 added a real test suite; Module 09 deploys it, unchanged)
...
`prettier` for formatting) and now Module 09. **The application code and
tests below are byte-for-byte unchanged from Module 08** — Module 09
only builds this exact code and ships the result to a real server; see
[`../deploy/`](../deploy/) and this module's own
[`../../BRIEF.md`](../../BRIEF.md) for that capstone. For the testing
